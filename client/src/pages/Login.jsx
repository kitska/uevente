	...
	return loading ? (
		...
		<div className='relative flex items-center justify-center min-h-screen overflow-hidden'>
			...
			<div
				...
				style={{
					backgroundImage:
						"url('https://images.unsplash.com/photo-1485470733090-0aae1788d5af?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8d2FsbHBhcGVyJTIwNGt8ZW58MHx8MHx8fDA%3D')",
				}}
			></div>
			<div className='absolute z-10 top-4 left-4'>
				<button onClick={() => navigate('/')} className='p-2 text-2xl font-semibold text-white transition bg-opacity-50 rounded-lg cursor-pointer hover:bg-opacity-70'>
					Go Event
				</button>
			</div>
			...
			<div className='relative z-10 w-full max-w-md p-8 bg-white rounded-lg shadow-xl'>
				...
				<form onSubmit={handleSubmit} className='flex flex-col gap-6'>
					...
					<button type='submit' className='p-3 text-white transition duration-200 rounded-lg bg-gradient-to-r from-blue-500 to-indigo-500 hover:opacity-80'>
						Sign in
					</button>
				...
				{profile ? (
					<div className='flex flex-col items-center'>
						...
						<button onClick={logOut} className='p-3 mt-3 text-white transition duration-200 bg-red-500 rounded-lg hover:bg-red-600'>
							Log out
						</button>
					</div>
				) : (
